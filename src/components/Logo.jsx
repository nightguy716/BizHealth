/**
 * Logo.jsx — Neon ECG logo. Animated pulse line in cyan/orange.
 * The green live dot pulses. The ECG stroke animates continuously.
 */
export default function Logo({ size = 38 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect width="40" height="40" rx="10" fill="url(#ecgGrad)" opacity="0.08"/>
