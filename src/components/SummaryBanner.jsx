        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button onClick={onExportExcel} disabled={exporting}
              className="inline-flex items-center gap-2 text-xs font-semibold px-4 py-2.5 rounded-xl transition-all duration-200 disabled:opacity-50"
              style={{ background:'rgba(0,176,80,0.1)', border:'1px solid rgba(0,176,80,0.3)', color:'#00B050' }}>
              {exporting ? (
